...
import io.github.sinri.keel.utils.CryptographyUtils;
import io.github.sinri.keel.utils.encryption.aes.KeelAes;
import io.github.sinri.keel.utils.encryption.rsa.KeelRSA;
import io.github.sinri.keel.utils.encryption.rsa.KeelRSAKeyPair;
...
class CryptographyUtilsTest extends KeelJUnit5Test {

    public CryptographyUtilsTest(Vertx vertx) {
        super(vertx);
    }
    ...
    void testGetInstance() {
        // 测试单例模式
        CryptographyUtils instance1 = CryptographyUtils.getInstance();
        CryptographyUtils instance2 = CryptographyUtils.getInstance();
    ...
    void testAesWithValidAlgorithm() {
        CryptographyUtils helper = CryptographyUtils.getInstance();
        ...
        for (KeelAes.SupportedCipherAlgorithm algorithm : algorithms) {
            KeelAes aes = CryptographyUtils.aes(algorithm, testKey);
            assertNotNull(aes);
    ...
    void testAesWithNullAlgorithm() {
        ...
        assertThrows(NullPointerException.class, () -> {
            CryptographyUtils.aes(null, testKey);
        });
    }
    ...
    void testAesWithNullKey() {
        ...
        assertThrows(NullPointerException.class, () -> {
            CryptographyUtils.aes(KeelAes.SupportedCipherAlgorithm.AesCbcPkcs5Padding, null);
        });
    }
    ...
    void testAesEncryptionDecryption() throws NoSuchAlgorithmException {
        ...
        // 测试 CBC 模式
        KeelAes aesCbc = CryptographyUtils.aes(KeelAes.SupportedCipherAlgorithm.AesCbcPkcs5Padding, testKey);
        ...
        // 测试 ECB 模式
        KeelAes aesEcb = CryptographyUtils.aes(KeelAes.SupportedCipherAlgorithm.AesEcbPkcs5Padding, testKey);
    ...
    void testRsa() {
        ...
        KeelRSA rsa = CryptographyUtils.rsa();
        assertNotNull(rsa);
    ...
    void testAesWithEmptyString() {
        ...
        assertThrows(IllegalArgumentException.class, () -> {
            KeelAes aes = CryptographyUtils.aes(KeelAes.SupportedCipherAlgorithm.AesCbcPkcs5Padding, emptyKey);
    ...
    void testAesWithSpecialCharacters() {
        ...
        KeelAes aes = CryptographyUtils.aes(KeelAes.SupportedCipherAlgorithm.AesCbcPkcs5Padding, specialKey);
    ...
    void testAesWithUnicodeText() throws NoSuchAlgorithmException {
        ...
        KeelAes aes = CryptographyUtils.aes(KeelAes.SupportedCipherAlgorithm.AesCbcPkcs5Padding, testKey);
