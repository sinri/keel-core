...
public class IntravenouslyCutterOnString extends IntravenouslyCutter<String> {
     ...
     */
    public IntravenouslyCutterOnString(Keel keel, Intravenous.SingleDropProcessor<String> stringSingleDropProcessor, long timeout) {
     ...
     * @param stringSingleDropProcessor 切分出的字符串文本片段处理器，由内置的{@link Intravenous}实例调用
     */
    public IntravenouslyCutterOnString(Keel keel, Intravenous.SingleDropProcessor<String> stringSingleDropProcessor) {
