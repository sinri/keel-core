...
class ReflectionUtilsTest extends KeelJUnit5Test {

    public ReflectionUtilsTest(Vertx vertx) {
        super(vertx);
    }
    ...
    void testGetInstance() {
        ...
        var instance1 = ReflectionUtils.getInstance();
        var instance2 = ReflectionUtils.getInstance();
    ...
    void testGetAnnotationOfMethod() throws NoSuchMethodException {
        var helper = ReflectionUtils.getInstance();
