...
public class MD5FileChecker {
    ...
    public String calculateFileMD5(String filePath) {
        try {
            ...
            return Keel.digestHelper().md5(fileContentString);
        } catch (Exception e) {
...
public class DataIntegrityService {
    ...
    public String generateChecksum(String data) {
        return Keel.digestHelper().sha256(data);
    }
    ...
    public String generateFileFingerprint(String filePath) {
        try {
            byte[] fileContent = Keel.fileHelper().readFileAsByteArray(filePath, false);
            String contentString = new String(fileContent, "UTF-8");
            return Keel.digestHelper().sha512(contentString);
        } catch (Exception e) {
...
2. **性能考虑**: MD5 使用了 FastThreadLocal 优化，性能最佳
