 ...
 * @since 5.0.0
 */
public interface AESValueEnveloping extends ValueEnveloping<@Nullable String, @Nullable String> {
    /**
     * Encrypt the raw string and store the encrypted value with this instance.
     *
     * @param raw The raw string value.
     */
    @Nullable String encrypt(@Nullable String raw);

    /**
     * Decrypt the stored value and return the raw string.
     */
    @Nullable String decrypt(@Nullable String decrypted);
}
